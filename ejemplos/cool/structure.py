...
#La global allClasses se define más abajo para poder hacer SymbolTable()
...
class SymbolTableWithScopes(MutableMapping):
    ...
    La klass es para que si no existe en locales, buscar en atributos
    """
